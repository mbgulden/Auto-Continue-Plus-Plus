...
export class ContractManager {
    ...
    public generateEnforcementPrompt(contract: AgentContract): string {
        ...
        prompt += `\n4. TASK COMPLETION: As your VERY LAST ACTION before stopping, you MUST execute a terminal command to delete your own contract file to signal to the Orchestrator that you are done. Run: \`rm .antigravity/contracts/${contract.threadId}.json\` (or \`del .antigravity\\contracts\\${contract.threadId}.json\` on Windows).\n`;
